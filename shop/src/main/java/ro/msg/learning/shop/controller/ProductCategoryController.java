...
public class ProductCategoryController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> delete(@PathVariable("id") UUID productCategoryId) {
        return new ResponseEntity<>(productCategoryService.deleteProductCategory(productCategoryId), HttpStatus.OK);
    }

    @PutMapping("/{id}")
    public ResponseEntity<String> put(@PathVariable("id") UUID productCategoryId, @RequestBody ProductCategoryDto productCategoryDto) {
