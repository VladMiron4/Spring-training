...
public class ProductController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> delete(@PathVariable("id") UUID productId) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> put(@PathVariable("id") UUID productId, @RequestBody ProductDto productDto) {
